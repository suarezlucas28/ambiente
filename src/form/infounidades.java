...
public class infounidades extends javax.swing.JPanel {
DefaultTableModel modelo = new DefaultTableModel(){
    ...
    public infounidades() throws SQLException, ClassNotFoundException, InstantiationException, IllegalAccessException {
        initComponents();
        cabecera();
        des_op();
        des_btn();
    ...
    public void cargadatos() throws SQLException, ClassNotFoundException, InstantiationException, IllegalAccessException{
        String SQL = null;
        if(op2.isSelected()){
        SQL = "SELECT `uni_codigo`,`uni_descri` FROM `unidades`";  
        }
    ...
    try {
    if (op1.isSelected()){
    sentencia = "SELECT unidades.`uni_codigo` AS unidades_uni_codigo,unidades.`uni_descri` AS unidades_uni_descri FROM `unidades` unidades ORDER BY uni_descri"; 
    } else if (op2.isSelected()){
    sentencia = "SELECT unidades.`uni_codigo` AS unidades_uni_codigo,unidades.`uni_descri` AS unidades_uni_descri FROM `unidades` unidades where uni_codigo = "+cliente;
    } 
...
reporte = "runidades";
    ...
    private void op2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_op2ActionPerformed
        try {
            ...
            Logger.getLogger(infounidades.class.getName()).log(Level.SEVERE, null, ex);
