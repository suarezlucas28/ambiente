 ...
 * @author LUke
 */
public class mo extends javax.swing.JPanel {
...
DefaultTableModel modelo = new DefaultTableModel(){
    ...
    public mo() throws SQLException, ClassNotFoundException, InstantiationException, IllegalAccessException {
        initComponents();
        des_btn();
        cabeceragrilla();
        cargagrilla();
...
private void gencod(){
	...
	ver_conex  conn = new ver_conex();
        ...
        conn.resultado = conn.sentencia.executeQuery("SELECT IFNULL(MAX(mdo_codigo),0)+1 AS xxx FROM mano_de_obra");
        conn.resultado.next();
...
private void cargagrilla() throws SQLException{
    ver_conex  conn = new ver_conex();
    conn.sentencia = conn.conexion.createStatement();
    conn.resultado = conn.sentencia.executeQuery("SELECT mdo_codigo,mdo_descri from mano_de_obra order by mdo_descri");
...
private void operaciones (){
        try {
            String SQL = "call abm_mdo("+operacion+","+txtcodigo.getText()+",'"+txtdescripcion.getText()+"',"+unidad+")";
            ...
            JOptionPane.showMessageDialog(null, "Se ha producido un error en la operación o bien esta intentando borrar una item de Mano de Obra en uso", "", JOptionPane.ERROR_MESSAGE);
            Logger.getLogger(mo.class.getName()).log(Level.SEVERE, null, ex);
        }
}
...
String SQL = "Select uni_descri from unidades";
ver_conex  conn = new ver_conex();
conn.sentencia = conn.conexion.createStatement();
...
jComboBox1.addItem(conn.resultado.getString("uni_descri"));
    ...
    private void initComponents() {
        ...
        setMaximumSize(new java.awt.Dimension(510, 185));
        setMinimumSize(new java.awt.Dimension(510, 185));
        setPreferredSize(new java.awt.Dimension(510, 185));
    ...
    private void grillaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_grillaMouseClicked
        try {
            String codigo = modelo.getValueAt(grilla.getSelectedRow(), 0).toString();
                    ...
                    ver_conex conn = new ver_conex();//instanciamos
                    conn.sentencia = conn.conexion.createStatement();
                    conn.resultado = conn.sentencia.executeQuery("SELECT * FROM mano_de_obra WHERE mdo_codigo = " + codigo);
                    conn.resultado.next();
