 ...
 * @author Luke
 */
public class pagosmo1 extends javax.swing.JPanel {
    ...
    public pagosmo1() throws SQLException {
        initComponents();
    ...
    private void gencod() {
        try {
            ...
            conn.resultado = conn.sentencia.executeQuery("SELECT IFNULL(MAX(pag_codigo),0)+1 AS xxx FROM pagos1");
            conn.resultado.next();
    ...
    private void cargagrilla() throws SQLException {
        ver_conex conn = new ver_conex();
        conn.sentencia = conn.conexion.createStatement();
        conn.resultado = conn.sentencia.executeQuery("SELECT pag_codigo,pag_destin FROM pagos1 WHERE pag_estado LIKE 'ACTIVO' ORDER BY pag_codigo DESC");
    ...
    private void grabar() throws SQLException {
        Fecha("Fecha");
        ver_conex conn = new ver_conex();
        String SQL = "INSERT INTO pagos1 (pag_codigo,usu_codigo,pag_concep,pag_horfec,pag_monto,pag_destin,pag_numletra,pag_observ,pag_fecrec) VALUES ("+txtcodigo.getText()+","+acceso.usuario+",'"+txt_item_cod.getText()+"','"+fechahora+"',"+txtmontoacobrar.getText()+",'"+txtdestinatario.getText()+"','"+numletra+"','"+txtobserva.getText()+"','"+txtfdesde.getText()+"')";
    ...
    private void imprimir() throws SQLException, JRException {
        try {
            ...
            String sentencia = "SELECT pag_codigo,pag_monto AS monto,pag_destin AS cliente,pag_numletra,pag_concep,DAY(`pag_fecrec`) AS dia, MONTH(`pag_fecrec`) AS mes, YEAR(`pag_fecrec`) AS anno,pag_observ FROM pagos1 WHERE pag_codigo = " + txtcodigo.getText();
            ////////////////////////////////instanciamos
        ...
        ////////////////////////////// preapra el patch
        URL urlMaestro = getClass().getClassLoader().getResource("repo/recibo1-1.jasper");
        ////////////////////////////// Cargamos el reporte
    ...
    public void grilla3() {
        ...
        try {
            ...
            recur1 = snt.executeQuery("SELECT pag_codigo,pag_destin,pag_monto,pag_horfec FROM pagos1 WHERE pag_destin LIKE '%" + wqqqq + "%' AND pag_estado LIKE 'ACTIVO' ORDER BY pag_codigo DESC");
            if (recur1.wasNull()) {
                ab = 0;
                return;
            }
            ...
            if (recur1.next()) {
                do {
                    ...
                    ac = recur1.getString("pag_destin");
    ...
    private void cargadatos() throws SQLException {
        ver_conex conn = new ver_conex();
        conn.sentencia = conn.conexion.createStatement();
        conn.resultado = conn.sentencia.executeQuery("SELECT pag_codigo,pag_destin,pag_monto,pag_destin,pag_fecrec FROM pagos1 WHERE pag_codigo = " + txtcodigo.getText());
        conn.resultado.next();
        txtcodigo.setText(conn.resultado.getString("pag_codigo"));
        txt_item_cod.setText(conn.resultado.getString("pag_destin"));
    ...
    private void borrar() throws SQLException {
        String SQL;
        SQL = "UPDATE pagos1 SET pag_estado = 'ANULADO' WHERE pag_codigo = " + txtcodigo.getText();
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                        .addGroup(javax.swing.GroupLayout.Alignment.LEADING, layout.createSequentialGroup()
                                            ...
                                            .addComponent(txtdestinatario, javax.swing.GroupLayout.PREFERRED_SIZE, 157, javax.swing.GroupLayout.PREFERRED_SIZE))
                                        .addGroup(layout.createSequentialGroup()
                                            .addComponent(jLabel3)
                                            .addGap(29, 29, 29)
                                            .addComponent(txt_item_cod))
                                        .addGroup(layout.createSequentialGroup()
        ...
        try {
            ...
            if (mensaje == JOptionPane.YES_OPTION)//si quiere borrar
            {
                try {
                    ...
                    Logger.getLogger(pagosmo1.class.getName()).log(Level.SEVERE, null, ex);
                }
    ...
    private void txtcodigoKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtcodigoKeyPressed
        if (evt.getKeyChar() == KeyEvent.VK_ENTER) {
            try {
                ver_conex conn = new ver_conex();
                conn.sentencia = conn.conexion.createStatement();
                conn.resultado = conn.sentencia.executeQuery("SELECT pag_codigo,pag_destin,pag_monto,pag_horfec FROM pagos1 WHERE pag_estado LIKE 'ACTIVO' ORDER BY pag_codigo DESC");
                modelo3.setRowCount(0);
...
if (txt_item_cod.getText().length() == 254) {
