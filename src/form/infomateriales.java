...
public class infomateriales extends javax.swing.JPanel {
DefaultTableModel modelo = new DefaultTableModel(){
    ...
    public infomateriales() throws SQLException, ClassNotFoundException, InstantiationException, IllegalAccessException {
        initComponents();
        cabecera();
        des_op();
        des_btn();
    ...
    public void cargadatos() throws SQLException, ClassNotFoundException, InstantiationException, IllegalAccessException{
        String SQL = null;
        if(op2.isSelected()){
        SQL = "SELECT `ite_codigo`,`ite_descri` FROM `items`";  
        }
    ...
    try {
    if (op1.isSelected()){
    sentencia = "SELECT I.ite_codigo,I.ite_descri,U1.uni_descri descri1,I.ite_medcom,U2.uni_descri descri2,I.ite_costo FROM items I INNER JOIN unidades U1 ON I.uni_codigo = U1.uni_codigo INNER JOIN unidades U2 ON I.uni_precom = U2.uni_codigo ORDER BY ite_descri"; 
    } else if (op2.isSelected()){
    sentencia = "SELECT I.ite_codigo,I.ite_descri,U1.uni_descri descri1,I.ite_medcom,U2.uni_descri descri2,I.ite_costo FROM items I INNER JOIN unidades U1 ON I.uni_codigo = U1.uni_codigo INNER JOIN unidades U2 ON I.uni_precom = U2.uni_codigo where ite_codigo = "+cliente;
    } 
...
reporte = "rmateriales";
    ...
    private void op2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_op2ActionPerformed
        try {
            ...
            Logger.getLogger(infomateriales.class.getName()).log(Level.SEVERE, null, ex);
