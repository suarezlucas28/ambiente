...
public class inforubros extends javax.swing.JPanel {
DefaultTableModel modelo = new DefaultTableModel(){
    ...
    public inforubros() throws SQLException, ClassNotFoundException, InstantiationException, IllegalAccessException {
        initComponents();
        cabecera();
        des_op();
        des_btn();
    ...
    public void cargadatos() throws SQLException, ClassNotFoundException, InstantiationException, IllegalAccessException{
        String SQL = null;
        if(op2.isSelected()){
        SQL = "SELECT `rub_codigo`,`rub_descri` FROM `rubro`";  
        }
    ...
    cc.getColumnModel().getColumn(1).setPreferredWidth(151);
     ...
     private void gen_reporte1() throws JRException {
        /////////////////////////////////instanciamos
        ver_conex conn = new ver_conex();
        HashMap parameters = new HashMap();
        ///////////////////////////////// preparamos parametros del reporte
        parameters.put("obra", cliente);
        parameters.put("SUBREPORT_DIR", "\\ambiente\\src\\repo\\");
        ///////////////////////////////// patch de los reporetes
        URL urlMaestro = getClass().getClassLoader().getResource("repo/rrubros1.jasper");
        ///////////////////////////////// Cargamos el reporte
        des_op();
        des_btn();
        modelo.setRowCount(0);
      ...
      private void gen_reporte() throws JRException {
        /////////////////////////////////instanciamos
        ver_conex conn = new ver_conex();
        HashMap parameters = new HashMap();
        ///////////////////////////////// preparamos parametros del reporte
        parameters.put("SUBREPORT_DIR", "\\ambiente\\src\\repo\\");
        ///////////////////////////////// patch de los reporetes
        URL urlMaestro = getClass().getClassLoader().getResource("repo/rrubros.jasper");
        ///////////////////////////////// Cargamos el reporte
        des_op();
        des_btn();
        modelo.setRowCount(0);
...
reporte = "rclientes";
    ...
    private void op2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_op2ActionPerformed
        try {
            ...
            Logger.getLogger(inforubros.class.getName()).log(Level.SEVERE, null, ex);
