...
public class infopaproveedores extends javax.swing.JPanel {
    ...
    public infopaproveedores() throws ClassNotFoundException, InstantiationException, IllegalAccessException, SQLException {
        initComponents();
        cargacliente();
        des_op();
        des_btn();
    ...
    try {
    if (op1.isSelected()){
    sentencia = "SELECT paprove.`ppr_codigo` AS paprove_ppr_codigo,proveedor.`pro_nombre` AS proveedor_pro_nombre,paprove.`ppr_horfec` AS paprove_ppr_horfec,paprove.`ppr_monto` AS paprove_ppr_monto,obras.`obr_proyec` AS obras_obr_proyec,cliente.`cli_nomape` AS cliente_cli_nomape,usuarios.`usu_usuari` AS usuarios_usu_usuari FROM `usuarios` usuarios INNER JOIN `paprove` paprove ON usuarios.`usu_codigo` = paprove.`usu_codigo` INNER JOIN `obras` obras ON usuarios.`usu_codigo` = obras.`usu_codigo` AND obras.`obr_codigo` = paprove.`obr_codigo` INNER JOIN `proveedor` proveedor ON paprove.`pro_codigo` = proveedor.`pro_codigo`,`cliente` cliente WHERE cliente.cli_codigo = obras.cli_codigo AND ppr_estado LIKE 'ACTIVO' ORDER BY ppr_codigo DESC";    
    } else if (op2.isSelected()){
    sentencia = "SELECT paprove.`ppr_codigo` AS paprove_ppr_codigo,proveedor.`pro_nombre` AS proveedor_pro_nombre,paprove.`ppr_horfec` AS paprove_ppr_horfec,paprove.`ppr_monto` AS paprove_ppr_monto,obras.`obr_proyec` AS obras_obr_proyec,cliente.`cli_nomape` AS cliente_cli_nomape,usuarios.`usu_usuari` AS usuarios_usu_usuari FROM `usuarios` usuarios INNER JOIN `paprove` paprove ON usuarios.`usu_codigo` = paprove.`usu_codigo` INNER JOIN `obras` obras ON usuarios.`usu_codigo` = obras.`usu_codigo` AND obras.`obr_codigo` = paprove.`obr_codigo` INNER JOIN `proveedor` proveedor ON paprove.`pro_codigo` = proveedor.`pro_codigo`,`cliente` cliente WHERE cliente.cli_codigo = obras.cli_codigo AND ppr_estado LIKE 'ACTIVO' AND `ppr_codigo` = "+txtcodigo.getText();
    } else if (op3.isSelected()){
    sentencia = "SELECT paprove.`ppr_codigo` AS paprove_ppr_codigo,proveedor.`pro_nombre` AS proveedor_pro_nombre,paprove.`ppr_horfec` AS paprove_ppr_horfec,paprove.`ppr_monto` AS paprove_ppr_monto,obras.`obr_proyec` AS obras_obr_proyec,cliente.`cli_nomape` AS cliente_cli_nomape,usuarios.`usu_usuari` AS usuarios_usu_usuari FROM `usuarios` usuarios INNER JOIN `paprove` paprove ON usuarios.`usu_codigo` = paprove.`usu_codigo` INNER JOIN `obras` obras ON usuarios.`usu_codigo` = obras.`usu_codigo` AND obras.`obr_codigo` = paprove.`obr_codigo` INNER JOIN `proveedor` proveedor ON paprove.`pro_codigo` = proveedor.`pro_codigo`,`cliente` cliente WHERE cliente.cli_codigo = obras.cli_codigo AND ppr_estado LIKE 'ACTIVO' AND LEFT(`ppr_horfec`,10) BETWEEN  '"+txtfdesde.getText()+"' AND '"+txtfhasta.getText()+"' ORDER BY ppr_codigo DESC";    
    } else if (op4.isSelected()){
    sentencia = "SELECT paprove.`ppr_codigo` AS paprove_ppr_codigo,proveedor.`pro_nombre` AS proveedor_pro_nombre,paprove.`ppr_horfec` AS paprove_ppr_horfec,paprove.`ppr_monto` AS paprove_ppr_monto,obras.`obr_proyec` AS obras_obr_proyec,cliente.`cli_nomape` AS cliente_cli_nomape,usuarios.`usu_usuari` AS usuarios_usu_usuari FROM `usuarios` usuarios INNER JOIN `paprove` paprove ON usuarios.`usu_codigo` = paprove.`usu_codigo` INNER JOIN `obras` obras ON usuarios.`usu_codigo` = obras.`usu_codigo` AND obras.`obr_codigo` = paprove.`obr_codigo` INNER JOIN `proveedor` proveedor ON paprove.`pro_codigo` = proveedor.`pro_codigo`,`cliente` cliente WHERE cliente.cli_codigo = obras.cli_codigo AND ppr_estado LIKE 'ACTIVO' AND `paprove`.`pro_codigo` = "+cliente+" ORDER BY ppr_codigo DESC";    
    } else if (op8.isSelected()){
    sentencia = "SELECT paprove.`ppr_codigo` AS paprove_ppr_codigo,proveedor.`pro_nombre` AS proveedor_pro_nombre,paprove.`ppr_horfec` AS paprove_ppr_horfec,paprove.`ppr_monto` AS paprove_ppr_monto,obras.`obr_proyec` AS obras_obr_proyec,cliente.`cli_nomape` AS cliente_cli_nomape,usuarios.`usu_usuari` AS usuarios_usu_usuari FROM `usuarios` usuarios INNER JOIN `paprove` paprove ON usuarios.`usu_codigo` = paprove.`usu_codigo` INNER JOIN `obras` obras ON usuarios.`usu_codigo` = obras.`usu_codigo` AND obras.`obr_codigo` = paprove.`obr_codigo` INNER JOIN `proveedor` proveedor ON paprove.`pro_codigo` = proveedor.`pro_codigo`,`cliente` cliente WHERE cliente.cli_codigo = obras.cli_codigo AND ppr_estado LIKE 'ANULADO' ORDER BY ppr_codigo DESC";    
...
op1.requestFocus();
    ...
    private void btngenerarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btngenerarActionPerformed
        try {
            ...
            Logger.getLogger(infopaproveedores.class.getName()).log(Level.SEVERE, null, ex);
