...
public class infocliente2 extends javax.swing.JPanel {
DefaultTableModel modelo = new DefaultTableModel(){
    ...
    public infocliente2() throws SQLException, ClassNotFoundException, InstantiationException, IllegalAccessException {
        initComponents();
        cabecera();
        des_op();
        des_btn();
    ...
    public void cargadatos() throws SQLException, ClassNotFoundException, InstantiationException, IllegalAccessException{
        String SQL = null;
        if(op2.isSelected()){
        SQL = "SELECT `cli_codigo`,`cli_nomape` FROM `cliente`";  
        }
    ...
    try {
    if (op1.isSelected()){
    sentencia = "SELECT cliente.`cli_codigo` AS cliente_cli_codigo,cliente.`cli_nomape` AS cliente_cli_nomape,cliente.`cli_domici` AS cliente_cli_domici,cliente.`cli_telefo` AS cliente_cli_telefo FROM `cliente` cliente order by cli_nomape"; 
    } else if (op2.isSelected()){
    sentencia = "SELECT cliente.`cli_codigo` AS cliente_cli_codigo,cliente.`cli_nomape` AS cliente_cli_nomape,cliente.`cli_domici` AS cliente_cli_domici,cliente.`cli_telefo` AS cliente_cli_telefo FROM `cliente` cliente where cli_codigo = "+cliente;
    } 
...
reporte = "rclientes";
    ...
    private void op2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_op2ActionPerformed
        try {
            ...
            Logger.getLogger(infocliente2.class.getName()).log(Level.SEVERE, null, ex);
