...
public class infopamo extends javax.swing.JPanel {
    ...
    public infopamo() throws ClassNotFoundException, InstantiationException, IllegalAccessException, SQLException {
        initComponents();
        cargacliente();
        des_op();
        des_btn();
    ...
    try {
    if (op1.isSelected()){
    sentencia = "SELECT pagos.`pag_codigo` AS pagos_pag_codigo,CONCAT(cliente.`cli_nomape`,' - ',obras.`obr_proyec`) AS obra,pagos.`pag_horfec` AS pagos_pag_horfec,pagos.`pag_monto` AS pagos_pag_monto,pagos.`pag_destin` AS pagos_pag_destin,pagos.`pag_observ` AS pagos_pag_observ,pagos.`pag_fecrec` AS pagos_pag_fecrec,usuarios.`usu_usuari` AS usuarios_usu_usuari FROM `usuarios` usuarios INNER JOIN `pagos` pagos ON usuarios.`usu_codigo` = pagos.`usu_codigo` INNER JOIN `obras` obras ON usuarios.`usu_codigo` = obras.`usu_codigo` AND obras.`obr_codigo` = pagos.`obr_codigo`,`cliente` cliente WHERE cliente.cli_codigo = obras.cli_codigo AND pag_estado LIKE 'ACTIVO' order by pag_codigo desc";    
    } else if (op2.isSelected()){
    sentencia = "SELECT pagos.`pag_codigo` AS pagos_pag_codigo,CONCAT(cliente.`cli_nomape`,' - ',obras.`obr_proyec`) AS obra,pagos.`pag_horfec` AS pagos_pag_horfec,pagos.`pag_monto` AS pagos_pag_monto,pagos.`pag_destin` AS pagos_pag_destin,pagos.`pag_observ` AS pagos_pag_observ,pagos.`pag_fecrec` AS pagos_pag_fecrec,usuarios.`usu_usuari` AS usuarios_usu_usuari FROM `usuarios` usuarios INNER JOIN `pagos` pagos ON usuarios.`usu_codigo` = pagos.`usu_codigo` INNER JOIN `obras` obras ON usuarios.`usu_codigo` = obras.`usu_codigo` AND obras.`obr_codigo` = pagos.`obr_codigo`,`cliente` cliente WHERE cliente.cli_codigo = obras.cli_codigo AND pag_estado LIKE 'ACTIVO' AND `pag_codigo` = "+txtcodigo.getText();
    } else if (op3.isSelected()){
    sentencia = "SELECT pagos.`pag_codigo` AS pagos_pag_codigo,CONCAT(cliente.`cli_nomape`,' - ',obras.`obr_proyec`) AS obra,pagos.`pag_horfec` AS pagos_pag_horfec,pagos.`pag_monto` AS pagos_pag_monto,pagos.`pag_destin` AS pagos_pag_destin,pagos.`pag_observ` AS pagos_pag_observ,pagos.`pag_fecrec` AS pagos_pag_fecrec,usuarios.`usu_usuari` AS usuarios_usu_usuari FROM `usuarios` usuarios INNER JOIN `pagos` pagos ON usuarios.`usu_codigo` = pagos.`usu_codigo` INNER JOIN `obras` obras ON usuarios.`usu_codigo` = obras.`usu_codigo` AND obras.`obr_codigo` = pagos.`obr_codigo`,`cliente` cliente WHERE cliente.cli_codigo = obras.cli_codigo AND pag_estado LIKE 'ACTIVO' AND LEFT(`pag_horfec`,10) BETWEEN  '"+txtfdesde.getText()+"' AND '"+txtfhasta.getText()+"' order by pag_codigo desc";    
    } else if (op4.isSelected()){
    sentencia = "SELECT pagos.`pag_codigo` AS pagos_pag_codigo,CONCAT(cliente.`cli_nomape`,' - ',obras.`obr_proyec`) AS obra,pagos.`pag_horfec` AS pagos_pag_horfec,pagos.`pag_monto` AS pagos_pag_monto,pagos.`pag_destin` AS pagos_pag_destin,pagos.`pag_observ` AS pagos_pag_observ,pagos.`pag_fecrec` AS pagos_pag_fecrec,usuarios.`usu_usuari` AS usuarios_usu_usuari FROM `usuarios` usuarios INNER JOIN `pagos` pagos ON usuarios.`usu_codigo` = pagos.`usu_codigo` INNER JOIN `obras` obras ON usuarios.`usu_codigo` = obras.`usu_codigo` AND obras.`obr_codigo` = pagos.`obr_codigo`,`cliente` cliente WHERE cliente.cli_codigo = obras.cli_codigo AND pag_estado LIKE 'ACTIVO' AND `pagos`.`obr_codigo` = "+cliente+" order by pag_codigo desc";    
...
op1.requestFocus();
    ...
    private void btngenerarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btngenerarActionPerformed
        try {
            ...
            Logger.getLogger(infopamo.class.getName()).log(Level.SEVERE, null, ex);
