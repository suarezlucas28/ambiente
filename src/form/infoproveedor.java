...
DefaultTableModel modelo = new DefaultTableModel(){
    ...
    public infoproveedor() throws SQLException, ClassNotFoundException, InstantiationException, IllegalAccessException {
        initComponents();
        cabecera();
        cargadatos();
        des_op();
    ...
    try {
    if (op1.isSelected()){
    sentencia = "SELECT proveedor.`pro_domici` AS proveedor_pro_domici,proveedor.`pro_telefo` AS proveedor_pro_telefo,proveedor.`pro_nombre` AS proveedor_pro_nombre,proveedor.`pro_codigo` AS proveedor_pro_codigo FROM `proveedor` proveedor";
    } else if (op2.isSelected()){
    sentencia = "SELECT proveedor.`pro_domici` AS proveedor_pro_domici,proveedor.`pro_telefo` AS proveedor_pro_telefo,proveedor.`pro_nombre` AS proveedor_pro_nombre,proveedor.`pro_codigo` AS proveedor_pro_codigo FROM `proveedor` proveedor WHERE proveedor.`pro_codigo` = "+cliente;
    } 
    ...
    private void initComponents() {
        ...
        jPanel1.add(op1, new org.netbeans.lib.awtextra.AbsoluteConstraints(75, 7, -1, -1));
        ...
        jPanel1.add(op2, new org.netbeans.lib.awtextra.AbsoluteConstraints(195, 7, -1, -1));
...
reporte = "rproveedores";
    ...
    private void btngenerarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btngenerarActionPerformed
        try {
            ...
            Logger.getLogger(infoproveedor.class.getName()).log(Level.SEVERE, null, ex);
        }
